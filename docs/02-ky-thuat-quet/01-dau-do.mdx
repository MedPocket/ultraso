...
description: Tìm hiểu về các loại đầu dò siêu âm cốt lõi và các thao tác chuẩn hóa để di chuyển chúng trên cơ thể người bệnh.
---

Lựa chọn đúng loại đầu dò và làm chủ việc định hướng của nó trên da người bệnh là những điều kiện tiên quyết bắt buộc để có được hình ảnh chất lượng chẩn đoán.
...
<CardGroup cols={3}>
  <Card title="Đầu dò Linear (Phẳng)">
    Tần số cao (7–15 MHz hoặc cao hơn). Bề mặt phẳng. Độ phân giải vùng gần tuyệt vời, độ đâm xuyên
    nông. Lý tưởng cho tiếp cận mạch máu, tuyến giáp, cơ xương khớp (MSK) và dấu trượt phổi.
  </Card>
...
- **Mặt cắt ngang (Transverse Scan):** Dấu chỉ hướng của đầu dò phải hướng về phía **bên phải của người bệnh**.
- **Mặt cắt dọc/vành (Sagittal/Coronal Scan):** Dấu chỉ hướng của đầu dò phải hướng về phía **đầu của người bệnh (phía đầu - cephalad)**.
  :::
