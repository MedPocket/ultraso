...
Dưới đây là tổng hợp phân tích đối chiếu từ 3 nguồn bài giảng lâm sàng chuyên sâu và tổng quan quốc tế PMC6029298:

_Bảng "Tổng hợp so sánh trọng tâm nội dung từ các nguồn tài liệu"._

| Tiêu chí                    | Nguồn 1 (BS.CKII. Đỗ Thị Cẩm Giang - BV Nhi Đồng 1)                                                                            | Nguồn 2 & 3 (Bài giảng chuyên đề tim bẩm sinh)                                                                              | Nguồn 4 (Tổng quan PMC6029298 - Kao CC et al.)                                                                                                               |
| :-------------------------- | :----------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Phạm vi tiếp cận**        | Tập trung chuyên sâu vào **Siêu âm tim thai** trước sinh và phân tầng nguy cơ sơ sinh.                                         | Tập trung vào TAPVR trong bối cảnh **Tim bẩm sinh phức tạp** (Isomerism) và kỹ thuật siêu âm Doppler/Darling.               | Hệ thống hóa toàn diện từ **Phôi thai học, Di truyền, Phân loại Darling/Smith/Herlong, Tiêu chuẩn ISUOG & Kỹ thuật 4D (STIC)**.                              |
| **Điểm nhấn kỹ thuật**      | Tối ưu hóa cài đặt Doppler màu (vận tốc thấp **15 - 30 cm/s**), đo khoảng cách thành sau nhĩ trái - AO xuống (**> 2 - 3 mm**). | Khảo sát bất thường tầng nhĩ, vị trí dạ dày/gan (Situs), mặt cắt hõm ức/dưới sườn đánh giá phổ Doppler tắc nghẽn.           | Đưa ra ngưỡng định lượng **Post-LA Space Index > 1,27**; Dấu hiệu SVC phì đại (3VT, độ nhạy 72-100%); Dấu hiệu mạch máu bất thường giữa IVC-Ao (ngang bụng). |
| **Lưu ý lâm sàng mấu chốt** | Cảnh báo hiện tượng buồng tim thai không giãn trong TAPVR chưa tắc nghẽn; chống chỉ định PGE1 sau sinh khi có tắc nghẽn.       | Chìa khóa phân biệt Left vs Right Isomerism; Phân biệt TAPVR thể tại tim với PLSVC đơn thuần và PAPVR (Hội chứng Scimitar). | Khẳng định **RV > LV không đáng tin cậy trước 28 tuần**; Tắc nghẽn thể dưới tim do khe thực quản hoành; Tỷ lệ tử vong sau mổ hiện đã giảm xuống < 7,4%.      |
